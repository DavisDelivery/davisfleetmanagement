...
function App(){
  ...
  const runMotiveSync=async(plan)=>{
    ...
    loadMotiveData(motiveMap); // refresh permanent_driver so the plan reflects the push
  };
                        ...
                        {subNotes.map((n,ni)=>{
                          ...
                          return <div key={ni}>
                            <div style={{display:"flex",gap:6,alignItems:"center",flexWrap:"wrap"}}>
                              ...
                              <button onClick={()=>patchItem(r,idx,{notes:subNotes.filter((_,i)=>i!==ni)})} title="Delete note" style={{marginLeft:"auto",fontSize:10,color:"#cbd5e1",background:"none",border:"none",cursor:"pointer",padding:"2px 4px",lineHeight:1,flexShrink:0}}>✕</button>
                            </div>
