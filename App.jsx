            ...
            const renderRow=(t)=>{
              ...
              return <tr key={t.id} style={s.tr}>
                ...
                {DAYS.map((d,i)=>{
                  ...
                  const isToday=i===di;
                  const tsDay=(tStat[`${t.id}-${d}`]||"").toLowerCase();
                  const dayOOS=tsDay==="oos"||tsDay==="bd"||tsDay==="repair";
          ...
          {fleetView==="board"&&(()=>{
                      ...
                      {truckList.map(t=>{
                        ...
                        return <tr key={t.id} style={{...s.tr,background:isDown?"#fef2f2":"transparent"}}>
                          ...
                          {DAYS.map((d,i)=>{
                            const driver=truckDayDriver[`${t.id}-${d}`]||"";
                            const isToday=i===di;
                            const tsStat=tStat[`${t.id}-${d}`]||"";
                            const dayOOS=tsStat.toLowerCase()==="oos"||tsStat.toLowerCase()==="bd";
            ...
            return <div>
              <div style={{fontSize:11,color:"#6b7785",marginBottom:12}}>
                {fWL(weekDate)} · <span style={{fontWeight:700,color:C.brand}}>Today: {DAYS[di]}</span> (highlighted) · Click truck # for history
              </div>
