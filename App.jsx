            ...
            const renderCard=(r)=>{
              ...
              return <div key={r.id} style={{...s.repairCard,marginBottom:10}}>
                ...
                <div style={{marginTop:8}}>
                  <input
                    placeholder="Notes — what's wrong, status updates, etc."
                    defaultValue={r.notes||""}
                    onBlur={e=>{if(e.target.value!==(r.notes||""))updateRepair(r.id,{notes:e.target.value});}}
                    onKeyDown={e=>{if(e.key==="Enter")e.target.blur();}}
                    style={{width:"100%",fontSize:12,color:"#334155",padding:"6px 8px",border:"1px solid #e2e8f0",borderRadius:4,outline:"none",background:"#fff",boxSizing:"border-box"}}
                  />
                </div>
