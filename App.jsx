                  ...
                  {notesLog.map((entry,idx)=>{
                    ...
                    return <div key={idx} style={{display:"flex",flexDirection:"column",gap:4}}>
                      <div style={{display:"flex",gap:8,alignItems:"flex-start"}}>
                        ...
                        <span style={{fontSize:12,color:entry.done?"#94a3b8":"#334155",flex:1,textDecoration:entry.done?"line-through":"none"}}>{entry.text}</span>
                      ...
                      {subNotes.length>0&&<div style={{marginLeft:26,display:"flex",flexDirection:"column",gap:3,borderLeft:"2px solid #e2e8f0",paddingLeft:8}}>
                        {subNotes.map((n,ni)=>{
                          ...
                          return <div key={ni} style={{display:"flex",gap:6,alignItems:"flex-start"}}>
                            <span style={{fontSize:9,color:"#b6c0cc",whiteSpace:"nowrap",marginTop:2,minWidth:74}}>{nlabel}</span>
                            <span style={{fontSize:11,color:"#475569",flex:1}}>{n.text}</span>
                            {n.by&&<span style={{fontSize:9,color:C.brand,fontWeight:600,whiteSpace:"nowrap",marginTop:2}}>— {n.by}</span>}
                            <button onClick={()=>patchItem(r,idx,{notes:subNotes.filter((_,i)=>i!==ni)})} title="Delete note" style={{fontSize:9,color:"#cbd5e1",background:"none",border:"none",cursor:"pointer",padding:"0 2px",lineHeight:1,flexShrink:0,marginTop:2}}>✕</button>
                          </div>;
                        })}
                      </div>}
