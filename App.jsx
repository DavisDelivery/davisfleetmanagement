              ...
              <div style={s.cBody}><Row l="Type" v={t.type==="straight"?"Box Truck":"Tractor"}/><Row l="Make" v={normalizeMake(t.mk)}/>
                ...
                <Row l="Year" v={
                  <input type="number" min="1980" max="2099" placeholder="—"
                    ...
                    style={{width:60,fontSize:11,padding:"2px 4px",border:"1px solid transparent",borderRadius:4,background:"transparent",outline:"none",color:t.year?C.dark:"#cbd5e1",fontWeight:600,textAlign:"right"}}
