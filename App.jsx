      ...
      <div style={s.body}>
        ...
        {tab==="board"&&<div>
          ...
          <details style={{marginBottom:12,padding:"8px 12px",background:"#fffbeb",border:`1px solid ${C.accent}55`,borderRadius:6}}>
            <summary style={{fontSize:11,fontWeight:700,color:C.accent,cursor:"pointer"}}>🔍 Data Diagnostic — click if data looks missing</summary>
            <div style={{marginTop:10,fontSize:11,fontFamily:"monospace",color:"#1e293b"}}>
              ...
              }} style={{marginTop:8,padding:"6px 12px",fontSize:11,fontWeight:700,background:C.brand,color:"#fff",border:"none",borderRadius:4,cursor:"pointer"}}>📊 List all assignment keys in Firebase</button>
              <button onClick={async()=>{
                try{
              ...
              }} style={{marginTop:8,marginLeft:8,padding:"6px 12px",fontSize:11,fontWeight:700,background:C.green,color:"#fff",border:"none",borderRadius:4,cursor:"pointer"}}>🔎 Check current week's raw Firebase data</button>
            </div>
          </details>
