...
function App(){
  ...
  const fetchGmailInvoices=async(vendor)=>{
    ...
    try{
      // Calculate 90 days ago for search
      ...
      try{
        ...
        setGmailResults(Array.isArray(results)?results:[results]);
      }catch(e){
        setGmailResults([{error:"Could not parse results: "+clean.substring(0,200)}]);
      }
    }catch(err){
