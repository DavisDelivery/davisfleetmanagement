...
function App(){
  ...
  // This lets us link invoice numbers even on cores (which don't store their own gmailRef).
  // Returns a URL string, or null if nothing linkable found.
